...
export default function Home() {
  return (
    <div className={styles.container}>
      ...
      <header>
    <nav class="bg-primary-1000 border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="md:container md:mx-auto flex flex-wrap justify-between items-center">
            <a href="https://flowbite.com" class="flex items-center">
                <img src="/fluiheaderv2.svg" class="mr-3 h-20 sm:h-30" alt="Flui Logo" />
...
<main className={styles.main}>
        <h1 class=" text-5xl text-primary-800 pb-6 text-center m-10">
        ...
        <div class="items-center bg-cover bg-alpha-sky w-full justify center p3 auto-cols-auto"> 
          <h2 class="font-bold text-4xl text-center p-3 text-primary-700"> ¿Qué es FLUI?</h2>
          <ul class="justify-center flex flex-row lg:order-1">
            <li class="m-8 h-200">
                  <div class=" flex flex-col bg-white max-w-sm rounded overflow-hidden shadow-lg pb-3 item center" >
                    <img class=" items-center h-40 w-full" src="/caract1.svg" alt="Sunset in the mountains"/>
                    <div class="px-6 py-4">
                      <div class="font-bold text-xl mb-2 text-center">Una Plataforma digital</div>
                      <p class=" text-l text-center">Quiere simplicar tu experiencia al momento de organizar tus celebraciones. Puedes escontrar todos los servicios y productos que quieres para tu evento en un sólo lugar.</p>
                    </div>
                  </div>
            </li>
            <li class="m-8 h-200">
                  <div class=" flex flex-col bg-white max-w-sm rounded overflow-hidden shadow-lg pb-3 item center" >
                    <img class=" items-center h-40 w-full" src="/caract2.svg" alt="Sunset in the mountains"/>
                    <div class="px-6 py-4">
                      <div class="font-bold text-xl mb-2 text-center">Un organizador de eventos</div>
                      <p class=" text-l text-center">Existe la opción de que organicen el evento por ti, tu sólo debes elegir los productos y servicios que deseas en tu celebración</p>
                    </div>
                  </div>
            </li>
            <li class="m-8 h-200">
                  <div class=" flex flex-col bg-white max-w-sm rounded overflow-hidden shadow-lg pb-3 item center" >
                    <img class=" items-center h-40 w-full" src="/marketplace.svg" alt="Sunset in the mountains"/>
                    <div class="px-6 py-4">
                      <div class="font-bold text-xl mb-2 text-center">Un Marketplace para eventos y celebraciones</div>
                      <p class=" text-l text-center"> Donde puedes ofrecer tus servicios y/o productos para celebraciones de cualquier tipo.</p>
                    </div>
                  </div>
            </li>
          </ul>
    ...
    <div class="flex justify-center bg-cover bg-alpha-sky w-full justify center p3 auto-cols-auto m-10"> 
      <div class=" flex flex-col justify-center bg-white max-w-sm rounded overflow-hidden shadow-lg pb-3  m-10" >
        <h2 class="font-bold text-4xl text-center p-3 text-primary-700">Queremos conocerte</h2>
                        <div class="px-6 py-4">
                        <CodigoQr text="https://docs.google.com/forms/d/e/1FAIpQLSdroClVhoXoA4liL6LY3OW823-a2trURDyyuA25INRd7Gl6Kw/viewform?usp=sf_link"></CodigoQr>
                          <div class="font-bold text-xl mb-2 text-center">Responde nuestra encuesta</div>
                          <p class=" text-l text-center">Buscamos entregar una buena experiencia, es muy importante para nosotros tu opinión. 
    ...
    <div class="justify-center bg-cover bg-white w-full justify center p-3 auto-cols-auto"> 
          <h2 class="font-bold text-4xl text-center p-3 text-primary-700"> Equipo</h2>
          <ul class=" justify-center flex flex-row lg:order-1">
            <li class="m-8 h-200">
                  <div class=" flex flex-col bg-alpha-sky max-w-sm rounded overflow-hidden shadow-lg p-3 item center" >
            ...
            <li class="m-8 h-200">
                  <div class=" flex flex-col bg-alpha-sky max-w-sm rounded overflow-hidden shadow-lg p-3 item center" >
                    <img class=" items-center h-40 w-full" src="/male.svg" alt="Sunset in the mountains"/>
                    <div class="px-6 py-4">
                      <div class="font-bold text-xl mb-2 text-center">Vedran Tomicic</div>
                      <p class=" font-bold text-l text-center">Chief Techology Officer</p>
            ...
            <li class="m-8 h-200">
                  <div class=" flex flex-col bg-alpha-sky max-w-sm rounded overflow-hidden shadow-lg p-3 item center" >
                    ...
                    <div class="px-6 py-4">
                      ...
                      <p class=" text-l text-center"> Estudiante de Geooegía, Universidad Católica del Norte</p>
                    </div>
                  </div>
            </li>
          </ul>
      ...
      <div class="bg-cover bg-white w-full justify center p-3 auto-cols-auto">
        <ul class=" justify-center flex flex-row lg:order-1">
          ...
          <li class="m-5 h-100"> 
          <a> <img class=" items-center h-20 w-full" src="/facebook.svg" alt="Sunset in the mountains"/></a>
            
          </li>
          <li class="m-5 h-100"> 
          <a> <img class=" items-center h-20 w-full" src="/linkedin.svg" alt="Sunset in the mountains"/></a>
          </li>
        </ul>
