          ...
          <ul class="justify-center flex flex-col sm:flex-row">
            <li class="m-4 h-50 sm:m-8 h-200">
                  <div class=" flex flex-col bg-white max-w-sm rounded overflow-hidden shadow-lg pb-3 item center" >
                    ...
                    <div class="px-6 py-4">
                      <div class="font-bold text-l sm:font-bold text-xl mb-2 text-center">Una Plataforma digital</div>
                      <p class=" text-sm sm:text-l text-center">Quiere simplicar tu experiencia al momento de organizar tus celebraciones. Puedes escontrar todos los servicios y productos que quieres para tu evento en un sólo lugar.</p>
                    </div>
                  </div>
            </li>
            <li class=" m-4 h-50 sm:m-8 h-200">
                  <div class=" flex flex-col bg-white max-w-sm rounded overflow-hidden shadow-lg pb-3 item center" >
                    ...
                    <div class="px-6 py-4">
                      <div class="font-bold text-l sm:font-bold text-xl mb-2 text-center">Un organizador de eventos</div>
                      <p class="text-sm  sm:text-l text-center">Existe la opción de que organicen el evento por ti, tu sólo debes elegir los productos y servicios que deseas en tu celebración</p>
                    </div>
                  </div>
            </li>
            <li class=" m-4 h-50 sm:m-8 h-200">
                  <div class=" flex flex-col bg-white max-w-sm rounded overflow-hidden shadow-lg pb-3 item center" >
                    ...
                    <div class="px-6 py-4">
                      <div class="font-bold text-l sm:font-bold text-xl mb-2 text-center">Un Marketplace para eventos y celebraciones</div>
                      <p class="text-sm  sm:text-l text-center"> Donde puedes ofrecer tus servicios y/o productos para celebraciones de cualquier tipo.</p>
                    </div>
                  </div>
            </li>
          </ul>
            ...
            <li class="m-4 h-50 sm:m-8 h-200">
                  <div class=" flex flex-col bg-alpha-sky max-w-sm rounded overflow-hidden shadow-lg p-3 item center" >
                    ...
                    <div class="px-6 py-4">
                      ...
                      <p class=" font-bold text-l text-center">Chief Technology Officer</p>
