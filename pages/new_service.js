...
export default function NewService() {
  ...
  function postService() {
    ...
    fetch(url, {
      ...
      .then(alert("Servicio creado con exito"))
      .catch((error) => {
  ...
  return (
    <>
        ...
        <h1 class="text-5xl text-primary-800  text-center m-10">Inicio</h1>
        ...
        <div class="flex flex-col justify-center items-center w-2/5 h-auto space-y-2">
          ...
          <button class=" p-2 rounded bg-primary-800 text-[#FFFFFF]" onClick={postService}>Crear Servicio</button>
        </div>
        </main>
